...
def main():
    ...
    # Import modules
    try:
        from pipelinecombat.harmonization import create_example_data, harmonize_data
        from pipelinecombat.statistics import create_example_behavioral_data, NeuroStatAnalyzer
    ...
    try:
        ...
        print("  harmonized_data, model = harmonize_data(data, covars, batch_col='SITE')")
    ...
    try:
        ...
        brain_data, behavioral_scores, covariates = create_example_behavioral_data(n_subjects=80)
        ...
        print(f"Found {n_significant_anova} significant group differences (FDR corrected)")
    ...
    try:
        ...
        print("  harmonized_fa, _ = harmonize_data(fa_data, covars_df, batch_col='SITE')")
    ...
    print("For real data analysis, replace synthetic data with actual neuroimaging files.")
